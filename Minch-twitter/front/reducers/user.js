...
export const initialState = {
  isLoggingOut: false, // Logout is on going
  isLoggingIn: false, // Logging
  logInErrorReason: "", // Failed Reason of Login
  isSignedUp: false, // Successs Sign up
  isSigningUp: false, // Sign up checking
  signUpErrorReason: "", // Failed Reason of Sign up
  me: null, // My info
  followingList: [], // Folllowing list
  followerList: [], // Follower list
  userInfo: null, // User Info
  isEditingNickname: false, // Change Name
  editNicknameErrorReason: "", // failed of Change name
...
export const LOG_IN_REQUEST = "LOG_IN_REQUEST"; // Action name
